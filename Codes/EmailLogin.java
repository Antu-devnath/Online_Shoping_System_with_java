...
import javax.swing.border.LineBorder;
  ...
  class EmailLogin extends JFrame
{
	JTextField t1,t2;
	JPasswordField p1;
	JButton b1,b2,b3,b4;
	...
	EmailLogin()
	{
		...
		b1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae){
				...
				BufferedReader reader = new BufferedReader(new FileReader(".\\Data\\login2.txt"));
					
				FileReader fr = new FileReader(".\\Data\\login2.txt");
		...
		b2 = new JButton("Sign in with Mobile Number");
		...
		b3 = new JButton("Sign in with User Name");
