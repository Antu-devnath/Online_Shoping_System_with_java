...
import javax.swing.border.LineBorder;
  ...
  class MobileLogin extends JFrame
{
	JTextField t1,t2;
	JPasswordField p1;
	JButton b1,b2,b3,b4;
	...
	MobileLogin()
	{
		super("MOBILE_NUMBER LOGIN PAGE");
		...
		b1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae){
				...
				BufferedReader reader = new BufferedReader(new FileReader(".\\Data\\login3.txt"));
					
				FileReader fr = new FileReader(".\\Data\\login3.txt");
